...
import Tokenmonics from "../components/Tokenomics";
      ...
      <div className={`${style.main_margin} ${style.border_x}`}>
          ...
          <div className={style.content_grid}>
            <div className={style.content_flex}>
              ...
              <p className={style.paragraph_padding_y}>
                ...
                capital on the blockchain through a blockbuster system never
                done before.
              </p>
        ...
        >
          <div className={style.heading_center}>
            ...
            />
            <p className="px-3">
              Launchpad meets NFT’s and Metaverse ecosystem
            </p>
          </div>
          <div className={style.heading_center}>
            <Image
        ...
        <div
          ref={astronautref}
          className={`${(style.border_y, style.content_box_padding)} `}
        >
          <div>
            <h1 className="text-center">/ What is Astronaut? /</h1>
            <p className="py-5">
              Let’s journey together into the next. Launchpad with ability for
              vestings to be liquid and transferrable through NFT’s. Metaverse
              and DeFi Gamification support ecosystem.
            </p>
          </div>
          <div
          ...
          <div className="flex gap-x-8 items-center py-3">
            <h1>02</h1>
            <p>
              Investors who seek to be part of the most sought after presales
              can enjoy savvy ROI’s on projects that launch on Astronaut.{" "}
            </p>
          </div>
          <div
          ...
          <div className={style.content_grid}>
            <div className={`${style.content_flex}  lg:pb-0 pb-12`}>
              ...
              <p className="pt-4 pb-12">
                With a combined 50+ years of experience in cryptocurrency we
                pride ourselves on transparency, tireless work ethic and
                integrity. , Astronaut team is fully doxxed and remotely located
                globally.
              </p>
              <PrimaryButton>
                <button style={{ padding: ".5rem 1rem" }}>
        ...
        <div className={`${style.border_y} py-12`}>
          ...
          <div className="md:px-14 px-5 py-12 grid lg:grid-cols-2 grid-cols-1 gap-8 items-center ">
            <div className="pt-8 ">
              ...
              <div
                className={`${style.border_y} border-[var(--mainColor)] py-3`}
              >
                <h3>Invest</h3>
                <p>
                  Opportunity to get into the most sought after ideas and
                  project offerings coming to the market. Astronaut launches
                  will have more incentive to buy at both ILO and launch without
                  getting dumped on by VC’s, presale and private sale investors.
                </p>
              </div>
              <div className="py-3">
                <h3>Earn</h3>
                <p>
                  Earn large APY’s on your vested tokens for believing in
                  projects and teams allowing them time to build and roll out
          ...
          <Tokenmonics tokenomicsref={tokenomicsref} />
        </div>
