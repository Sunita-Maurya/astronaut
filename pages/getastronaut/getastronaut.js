...
const style = {
  ...
  container_padding: "lg:px-32 md:px-14 px-5 py-8",
  text_center: "text-center",
  flex_utility:
    "flex items-center  gap-x-8 border border-x-0 border-[#8B2AD3] py-3",
    ...
    <>
      <Head>
        ...
        <link
          rel="preload"
          as="image"
          href="/assets/getastronautimages/whitekucoin.svg"
        ></link>
        <link
          rel="preload"
          as="image"
          href="/assets/getastronautimages/whiteuniswap.svg"
        ></link>
        <link
          rel="preload"
          as="image"
          href="/assets/getastronautimages/whitegate.svg"
        ></link>
        <link
          rel="preload"
          as="image"
          href="/assets/getastronautimages/whitemexc.svg"
        ></link>
        <link
          rel="preload"
          as="image"
          href="/assets/getastronautimages/whitebitmart.svg"
        ></link>
        <link
          rel="preload"
          as="image"
          href="/assets/getastronautimages/whiteshibaswaplogo.svg"
        ></link>
      </Head>
        ...
        <div className={`${style.main_margin} ${style.border_x}`}>
          ...
          <div className={style.container_padding}>
            ...
            <p className={` py-5 text-center`}>
              Join the Astronaut ecosystem! You must first acquire $NAUT, the
              primary token in the ecosystem. It will be the connector between
              all things $NAUT. For instance, to get into any new ILO’s or
              purchase NFT’s you need to stake $NAUT or $NAUT/ETH LP in the
              staking dApp.
            </p>
              ...
              <PrimaryButton>
                <button className="capitalize flex items-center whitespace-nowrap py-2 px-5">
                  ...
                  <RiArrowRightDownLine
                    className={`text-[30px] text-[var(--mainColor)]`}
                  />
                </button>
              </PrimaryButton>
            </div>
            {/* --------------------------- */}
            <div className="py-8">
              <h3 className="pt-3 text-[50px]">Token Utility</h3>

              <div className="c border-2 border-t-0 border-x-0 border-[var(--mainColor)]">
                <input className="input-box" type="checkbox" id="faq-1" />
                <div className=" py-3">
                  <span className="text-lg pr-5">01</span>{" "}
                  <span className="text-[25px] font-medium">LAUNCHPAD</span>
                </div>
              </div>
              <div className="c border-2 border-t-0 border-x-0 border-[var(--mainColor)]">
                <input className="input-box" type="checkbox" id="faq-2" />
                <div className=" py-3">
                  <span className="text-lg pr-5">02</span>
                  <span className="text-[25px] font-medium">STAKING</span>
                </div>
              </div>
              <div className="c border-2 border-t-0 border-x-0 border-[var(--mainColor)]">
                <input className="input-box" type="checkbox" id="faq-3" />
                <div className=" py-3">
                  <span className="text-lg pr-5">03</span>
              ...
              <div className="c border-2 border-t-0 border-x-0 border-[var(--mainColor)]">
                ...
                <div className=" py-3">
                  <span className="text-lg pr-5">03</span>
                  <span className="text-[25px] font-medium">GOVERNANCE</span>
                </div>
              </div>
            </div>
            {/* ------------------------- */}
          </div>
          <h4 className=" stroke-text xl:text-[4rem] lg:text-[3.2rem] text-[2rem]">
